export const translations = {
    ...
    lite_mode_desc: { en: "Zero setup — uses the KiddoLens shared key. Search & full features included.", zh: "零設定：使用 KiddoLens 共用金鑰，搜尋與完整功能都可用。" },
    pro_mode_title: { en: "Advanced Control", zh: "進階控制" },
    pro_mode_desc: { en: "Use your own API key with a dedicated quota — most reliable at peak times.", zh: "使用你自己的 API 金鑰與專屬配額，尖峰時段最穩定。" },
